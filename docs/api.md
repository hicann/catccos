...
// 指定数据搬运的方向和方式
using TileRemoteCopy = Comm::Tile::TileRemoteCopy<ArchTag, RemoteSrcType, RemoteDstType, CopyDirect::Put>;
using TileScheduler = Catlass::Epilogue::Tile::EpilogueIdentityTileSwizzle;

using AllGatherDispatch = Comm::AtlasA2CommRemoteCopy<UB_STAGES, true>;
...
// 第四步：指定通信时的数据搬运策略
using BlockScheduler = Catccos::Comm::Block::BlockCommSwizzle<0>;
...
>
class CommBlock <
    AtlasA2CommRemoteCopy<UB_STAGES_>,
    SrcType_,
    DstType_,
    CoreSplit_,
    BlockShape_,
