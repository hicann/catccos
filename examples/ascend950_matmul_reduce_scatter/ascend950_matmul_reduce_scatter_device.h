 ...
 */
#ifndef ASCEND950_MATMUL_REDUCE_SCATTER_KERNEL_H
#define ASCEND950_MATMUL_REDUCE_SCATTER_KERNEL_H
...
#include "catccos/dgemm/kernel/matmul_reduce_scatter_tla.hpp"
...
using Ascend950MatmulReduceScatterConfig_M0_128 = 
    Ascend950MatmulReduceScatterConfig<ElementA, LayoutA, ElementB, LayoutB, ElementD, LayoutD, 128, 256, 256>;
