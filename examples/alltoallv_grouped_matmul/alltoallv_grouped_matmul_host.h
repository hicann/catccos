 ...
 */
#ifndef ALLTOALLV_GMM_MATMUL_HOST_H
#define ALLTOALLV_GMM_MATMUL_HOST_H

#include "operator_registry.h"

class AllToAllVGroupedMatmulOperator : public CatccosOperator
{
   public:
    ...
    {
        return CocCommType::ALLTOALLV_GROUPED_MATMUL;
    }
...
// 注册这个算子
REGISTER_OPERATOR("AllToAllVGroupedMatmul", AllToAllVGroupedMatmulOperator);

#endif  // ALLTOALLV_GMM_MATMUL_HOST_H
