...
cd ${PROJECT_ROOT}/examples/ascend950_quant_allgather/
DATA_DIR=$(realpath ./out)
EXEC_BIN=${PROJECT_ROOT}/build/bin/ascend950_quant_allgather
source $PROJECT_ROOT/examples/ascend950_quant_allgather/scripts/env.sh
