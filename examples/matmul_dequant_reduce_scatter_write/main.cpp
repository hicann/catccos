...
int main(int argc, char **argv)
{
    ...
    uint8_t *scaleX1Ptr = kernelParams.customPtrs[0];
    uint8_t *scaleX2Ptr = kernelParams.customPtrs[1];
    uint8_t *biasPtr = kernelParams.customPtrs[2];
    ...
    DeviceOp deviceOp;
    deviceOp.Initialize(args, workspaceDevice);
