 ...
 */
#ifndef ASCEND950_ALLTOALLV_GMM_MATMUL_HOST_H
#define ASCEND950_ALLTOALLV_GMM_MATMUL_HOST_H

#include "operator_registry.h"

class Ascend950AllToAllVGroupedMatmulOperator : public CatccosOperator
{
   public:
    ...
    {
        return CocCommType::ASCEND950_ALLTOALLV_GROUPED_MATMUL;
    }
...
// 注册这个算子
REGISTER_OPERATOR("Ascend950AllToAllVGroupedMatmul", Ascend950AllToAllVGroupedMatmulOperator);

#endif  // ASCEND950_ALLTOALLV_GMM_MATMUL_HOST_H
