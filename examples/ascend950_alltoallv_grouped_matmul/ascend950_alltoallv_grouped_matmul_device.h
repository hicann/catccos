...
using Ascend950AllToAllVGroupedMatmulConfig_M0_128 =
    Ascend950AllToAllVGroupedMatmulConfig<ElementA, LayoutA, ElementB, LayoutB, ElementC, LayoutC, 128, 256, 256>;

template <class ElementA, class LayoutA, class ElementB, class LayoutB, class ElementC, class LayoutC>
using Ascend950AllToAllVGroupedMatmulConfig_M0_256 =
    Ascend950AllToAllVGroupedMatmulConfig<ElementA, LayoutA, ElementB, LayoutB, ElementC, LayoutC, 256, 128, 256>;
