...
>
CATLASS_DEVICE
void AllGatherMatmulDequantImpl(
...
)
{
    ...
    using PaddingHelperB = typename Catccos::Padding::PaddingHelper<BType, false>;
...
>
CATLASS_DEVICE
void AllGatherMatmulDequantImpl_M0_256(
    Catlass::GemmCoord& problemShape,
    Catlass::GemmCoord& l1TileShape,
    GM_ADDR gmA, LayoutA& layoutA,
    GM_ADDR gmB, LayoutB& layoutB,
...
{
    AllGatherMatmulDequantImpl<ArchTag, ElementA, LayoutA, ElementB, LayoutB,
...
>
CATLASS_DEVICE
void AllGatherMatmulDequantImpl_M0_128(
    Catlass::GemmCoord& problemShape,
    Catlass::GemmCoord& l1TileShape,
    GM_ADDR gmA, LayoutA& layoutA,
    GM_ADDR gmB, LayoutB& layoutB,
...
)
{
    ...
    if(m0 == 128){
        AllGatherMatmulDequantImpl_M0_128<ArchTag, ElementA, LayoutA, ElementB, LayoutB, ElementD, LayoutD, ElementScale, LayoutScale>(
            problemShape, l1TileShape, gmA, layoutA, gmB, layoutB,
            gmD, layoutD, gmScale, layoutScale,
            commInterval, commCoreSplit, commBlockShape, commTileShape, gmWorkSpace, symmetricPtr
        );
    } else {
        AllGatherMatmulDequantImpl_M0_256<ArchTag, ElementA, LayoutA, ElementB, LayoutB, ElementD, LayoutD, ElementScale, LayoutScale>(
            problemShape, l1TileShape, gmA, layoutA, gmB, layoutB,
            gmD, layoutD, gmScale, layoutScale,
            commInterval, commCoreSplit, commBlockShape, commTileShape, gmWorkSpace, symmetricPtr
        );  
