...
template <class ElementA, class LayoutA, class ElementB, class LayoutB, class ElementC, class LayoutC,
          bool EnablePadding_, uint32_t M0_ = 128, uint32_t N0_ = 256, uint32_t K0_ = 256>
struct AllGatherMatmulConfig
{
    ...
    using BlockMmad =
        Catlass::Gemm::Block::BlockMmad<MmadDispatchPolicy, L1TileShape, L0TileShape, AType, ActualTypeB, CType>;
    ...
    using CommDispatchPolicy = Comm::AtlasCommLocalCopy<ArchTag, UB_STAGES, IS_DYNAMIC>;
    using BlockComm =
        Comm::Block::CommBlock<CommDispatchPolicy, RemoteSrcType, RemoteDstType, void, TileRemoteCopy, TileScheduler>;

    using CommBackend = Arch::ShmemComm;
    using Kernel = DGemm::Kernel::AllGatherMatmul<GlobalPaddingB, BlockMmad, BlockComm, BlockMmadScheduler,
                                                  BlockCommScheduler, CommBackend, WORKSPACE_STAGES>;
...
// Without padding
template <class ElementA, class LayoutA, class ElementB, class LayoutB, class ElementC, class LayoutC>
using AllGatherMatmulConfig_M0_128 =
    AllGatherMatmulConfig<ElementA, LayoutA, ElementB, LayoutB, ElementC, LayoutC, false, 128, 256, 256>;
template <class ElementA, class LayoutA, class ElementB, class LayoutB, class ElementC, class LayoutC>
using AllGatherMatmulConfig_M0_256 =
    AllGatherMatmulConfig<ElementA, LayoutA, ElementB, LayoutB, ElementC, LayoutC, false, 256, 128, 256>;

// With padding
template <class ElementA, class LayoutA, class ElementB, class LayoutB, class ElementC, class LayoutC>
using AllGatherMatmulPaddingConfig_M0_128 =
    AllGatherMatmulConfig<ElementA, LayoutA, ElementB, LayoutB, ElementC, LayoutC, true, 128, 256, 256>;
template <class ElementA, class LayoutA, class ElementB, class LayoutB, class ElementC, class LayoutC>
using AllGatherMatmulPaddingConfig_M0_256 =
    AllGatherMatmulConfig<ElementA, LayoutA, ElementB, LayoutB, ElementC, LayoutC, true, 256, 128, 256>;
