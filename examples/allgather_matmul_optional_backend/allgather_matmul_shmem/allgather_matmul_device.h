...
template <
    class ElementA, class LayoutA, class ElementB, class LayoutB, class ElementC, class LayoutC, bool EnablePadding_,
...
struct AllGatherMatmulConfig {
    ...
    using Kernel = DGemm::Kernel::AllGatherMatmul<
        GlobalPaddingB, BlockMmad, BlockComm, BlockMmadScheduler, BlockCommScheduler, CommBackend, WORKSPACE_STAGES>;
