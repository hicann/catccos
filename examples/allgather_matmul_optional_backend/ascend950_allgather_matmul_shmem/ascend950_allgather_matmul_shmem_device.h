 ...
 */
#ifndef ASCEND950_ALLGATHER_MATMUL_SHMEM_DEVICE_H
#define ASCEND950_ALLGATHER_MATMUL_SHMEM_DEVICE_H
...
struct Ascend950AllGatherMatmulShmemConfig
{
    ...
    // therefore performs a local GM -> UB -> resolved peer GM copy.
    using AllGatherDispatch = Comm::AtlasCommLocalCopy<ArchTag, UB_STAGES, IS_DYNAMIC>;
    using BlockComm =
    ...
    using Kernel = DGemm::Kernel::Ascend950AllGatherMatmulWithLocalOptionalBackend<
        BlockMmad, BlockComm, BlockMmadScheduler, BlockCommScheduler, WORKSPACE_STAGES, CommBackend>;
