 ...
 */
#ifndef ASCEND950_ALLGATHER_MATMUL_SHMEM_HOST_H
#define ASCEND950_ALLGATHER_MATMUL_SHMEM_HOST_H

#include "operator_registry.h"

class Ascend950AllGatherMatmulShmemOperator : public CatccosOperator
{
   public:
                             ...
                             std::string dataFile) override
    {
        ...
        {
            std::vector<half> matrixA(static_cast<size_t>(cocTiling.m) * cocTiling.k, 1);
        ...
        {
            std::vector<half> matrixB(static_cast<size_t>(cocTiling.k) * cocTiling.n, 1);
...
REGISTER_OPERATOR("Ascend950AllGatherMatmulShmem", Ascend950AllGatherMatmulShmemOperator);

#endif  // ASCEND950_ALLGATHER_MATMUL_SHMEM_HOST_H
