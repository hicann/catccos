 ...
 */
#include "matmul_reduce_scatter_device.h"
#include "matmul_reduce_scatter_host.h"
...
using Config = MatmulReduceScatterConfig_M0_128<ElementA, LayoutA, ElementB, LayoutB, ElementD, LayoutD>;
...
int main(int argc, char** argv)
{
    ...
    auto op = OperatorRegistry::Instance().CreateOperator("MatmulReduceScatter");
    if (!op) {
        std::cout << "Operator MatmulReduceScatter not found!" << std::endl;
        return -1;
    }
