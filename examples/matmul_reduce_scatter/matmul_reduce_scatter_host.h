 ...
 */
#ifndef MATMUL_REDUCE_SCATTER_HOST_H
#define MATMUL_REDUCE_SCATTER_HOST_H

#include "operator_registry.h"

class MatmulReduceScatterOperator : public CatccosOperator {
public:
    ...
    CocCommType GetActualKernelType(const CocTilingParams &cocTiling) override {
        return CocCommType::MATMUL_REDUCE_SCATTER;
    }
...
// 注册这个算子
REGISTER_OPERATOR("MatmulReduceScatter", MatmulReduceScatterOperator);

#endif // MATMUL_REDUCE_SCATTER_HOST_H
