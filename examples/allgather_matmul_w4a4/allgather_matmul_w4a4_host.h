   ...
   public:
                             ...
                             std::string dataFile) override
    {
        ...
        if (dataFile != "")
        {
            ...
            ACL_CHECK(aclrtMemcpy(perTokenScaleDevice, perTokenScaleSize, perTokenScaleHost, perTokenScaleSize,
        ...
        else
        {
            ...
            ACL_CHECK(aclrtMemcpy(perTokenScaleDevice, perTokenScaleSize, matrixPerTokenScale.data(), perTokenScaleSize,
                                  ACL_MEMCPY_HOST_TO_DEVICE));
        }
