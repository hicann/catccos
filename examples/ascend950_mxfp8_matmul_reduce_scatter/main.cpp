 ...
 */
#include "ascend950_mxfp8_matmul_reduce_scatter_device.h"
#include "ascend950_mxfp8_matmul_reduce_scatter_host.h"
...
using ElementA = float8_e5m2_t;
using ElementB = float8_e5m2_t;
