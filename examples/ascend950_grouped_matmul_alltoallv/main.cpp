 ...
 */
#include "ascend950_grouped_matmul_alltoallv_device.h"
#include "ascend950_grouped_matmul_alltoallv_host.h"
...
using Config = Ascend950GroupedMatmulAllToAllVConfig_M0_128<ElementA, LayoutA, ElementB, LayoutB, ElementD, LayoutD>;
...
int main(int argc, char **argv)
{
    ...
    auto op = OperatorRegistry::Instance().CreateOperator("Ascend950GroupedMatmulAllToAllV");
    if (!op) {
        std::cout << "Operator Ascend950GroupedMatmulAllToAllV not found!" << std::endl;
        return -1;
    }
