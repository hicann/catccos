...
using Ascend950GroupedMatmulAllToAllVConfig_M0_128 =
    Ascend950GroupedMatmulAllToAllVConfig<ElementA, LayoutA, ElementB, LayoutB, ElementD, LayoutD, 128, 256, 256>;
