 ...
 */
#ifndef ASCEND950_GROUPED_MATMUL_ALLTOALLV_DEVICE_H
#define ASCEND950_GROUPED_MATMUL_ALLTOALLV_DEVICE_H
...
using Ascend950GroupedMatmulAllToAllVConfig_M0_128 = Ascend950GroupedMatmulAllToAllVConfig<ElementA, LayoutA, ElementB, LayoutB, ElementD, LayoutD, 128, 256, 256>;

template <class ElementA, class LayoutA, class ElementB, class LayoutB, class ElementD, class LayoutD>
using Ascend950GroupedMatmulAllToAllVConfig_M0_256 = Ascend950GroupedMatmulAllToAllVConfig<ElementA, LayoutA, ElementB, LayoutB, ElementD, LayoutD, 256, 128, 256>;
