 ...
 */
#ifndef ASCEND950_GROUPED_MATMUL_ALLTOALLV_HOST_H
#define ASCEND950_GROUPED_MATMUL_ALLTOALLV_HOST_H

#include "operator_registry.h"

class Ascend950GroupedMatmulAllToAllVOperator : public CatccosOperator
{
   public:
    ...
    {
        return CocCommType::ASCEND950_GROUPED_MATMUL_ALLTOALLV;
    }
...
REGISTER_OPERATOR("Ascend950GroupedMatmulAllToAllV", Ascend950GroupedMatmulAllToAllVOperator);

#endif  // ASCEND950_GROUPED_MATMUL_ALLTOALLV_HOST_H
