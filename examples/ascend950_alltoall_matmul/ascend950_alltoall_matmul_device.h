 ...
 */
#ifndef ASCEND950_ALLTOALL_MATMUL_DEVICE_H
#define ASCEND950_ALLTOALL_MATMUL_DEVICE_H
...
using Ascend950AllToAllMatmulConfig_M0_128 =
    Ascend950AllToAllMatmulConfig<ElementA, LayoutA, ElementB, LayoutB, ElementC, LayoutC, 128, 256, 256>;
