...
CATLASS_DEVICE void QuantAllToAllImpl(
...
CATLASS_GLOBAL void QuantAllToAll(
    uint64_t fftsAddr, GM_ADDR gmInput, GM_ADDR gmScales, GM_ADDR gmOutput, GM_ADDR symmetricPtr,
    CocTilingParams cocTiling, uint32_t magic)
{
    ...
    QuantAllToAllImpl<ArchTag, ElementInput, LayoutInput, ElementOutput, LayoutOutput, ElementScale>(
        ...
        commBlockShape, commTileShape, symmetricPtr, magic, rank, rankSize);
}
