...
#include "matmul_reduce_scatter_shallow_fusion_device.h"
...
int main(int argc, char** argv)
{
    ...
    auto op = OperatorRegistry::Instance().CreateOperator("MatmulReduceScatterShallowFusion");
    ...
    try {
        ...
        Catccos::Examples::MatmulReduceScatterShallowFusionExample::Launch(
