...
using GroupedMatmulAllToAllVTlaConfig_M0_128 =
    GroupedMatmulAllToAllVTlaConfig<ElementA, LayoutA, ElementB, LayoutB, ElementD, LayoutD, 128, 256, 256>;

template <class ElementA, class LayoutA, class ElementB, class LayoutB, class ElementD, class LayoutD>
using GroupedMatmulAllToAllVTlaConfig_M0_256 =
    GroupedMatmulAllToAllVTlaConfig<ElementA, LayoutA, ElementB, LayoutB, ElementD, LayoutD, 256, 128, 256>;
