 ...
 */
#ifndef ASCEND950_FP8_MX_ALLTOALLV_GROUPED_MATMUL_HOST_H
#define ASCEND950_FP8_MX_ALLTOALLV_GROUPED_MATMUL_HOST_H

#include "catlass/detail/alignment.hpp"
#include "operator_registry.h"

class Ascend950Fp8MxAllToAllVGroupedMatmulOperator : public CatccosOperator {
public:
        ...
        KernelParams& params, const CocTilingParams& cocTiling, uint32_t rankId, std::string dataFile) override
    {
        ...
        if (dataFile != "") {
            ...
            ReadFileOrThrow(dataFile + "/input_a_" + std::to_string(rankId) + ".bin", aHost, sizeA);
        ...
        if (dataFile != "") {
            ...
            ReadFileOrThrow(dataFile + "/input_b_" + std::to_string(rankId) + ".bin", bHost, sizeB);
        ...
        if (dataFile != "") {
            ...
            ReadFileOrThrow(dataFile + "/input_a_scale_" + std::to_string(rankId) + ".bin", aMxScaleHost, sizeAScale);
            ...
            ACL_CHECK(
                aclrtMemcpy(aMxScaleDevice, sizeAScale, matrixAMxScale.data(), sizeAScale, ACL_MEMCPY_HOST_TO_DEVICE));
        }
        ...
        if (dataFile != "") {
            ...
            ReadFileOrThrow(dataFile + "/input_b_scale_" + std::to_string(rankId) + ".bin", bMxScaleHost, sizeBScale);
            ...
            ACL_CHECK(
                aclrtMemcpy(bMxScaleDevice, sizeBScale, matrixBMxScale.data(), sizeBScale, ACL_MEMCPY_HOST_TO_DEVICE));
        }
    ...
    {
        return CocCommType::ASCEND950_FP8_MX_ALLTOALLV_GROUPED_MATMUL;
    }
...
// 注册这个算子
REGISTER_OPERATOR("Ascend950Fp8MxAllToAllVGroupedMatmul", Ascend950Fp8MxAllToAllVGroupedMatmulOperator);

#endif // ASCEND950_FP8_MX_ALLTOALLV_GROUPED_MATMUL_HOST_H
