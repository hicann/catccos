 ...
 */
#ifndef ALLGATHER_MATMUL_REMOTE_READ_KERNEL_H
#define ALLGATHER_MATMUL_REMOTE_READ_KERNEL_H
...
struct AllGatherMatmulRemoteReadConfig {
    ...
    using BlockLocalCopy = Comm::Block::CommBlock<
        ...
        LocalCopySrcType, LocalCopyDstType,
        void,
...
using AllGatherMatmulRemoteReadConfig_M0_128 =
    AllGatherMatmulRemoteReadConfig<ElementA, LayoutA, ElementB, LayoutB, ElementC, LayoutC, 128, 256, 256>;
