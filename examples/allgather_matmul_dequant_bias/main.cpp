...
using Config = AllGatherMatmulDequantBiasConfig_M0_128<
    ElementA, LayoutA, ElementB, LayoutB, ElementC, LayoutC, ElementScale, LayoutScale>;
using DeviceOp = Config::Device;

struct Options {
    static constexpr auto HELPER =
       "Usage: allgather_matmul_dequant_bias rank_size rank_id ip_port m n k data_path [device_id_list]\n";
