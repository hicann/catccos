#ifndef ALLGATHER_MATMUL_RDMA_HOST_H
#define ALLGATHER_MATMUL_RDMA_HOST_H

#include "operator_registry.h"

class AllGatherMatmulRdmaOperator : public CatccosOperator {
public:
    ...
    CocCommType GetActualKernelType(const CocTilingParams &cocTiling) override {
        return CocCommType::ALLGATHER_MATMUL_RDMA;
    }
...
// 注册这个算子
REGISTER_OPERATOR("AllGatherMatmulRdma", AllGatherMatmulRdmaOperator);

#endif // ALLGATHER_MATMUL_RDMA_HOST_H