...
)
{
    ...
    using AllGatherMatmulKernel = DGemm::Kernel::AllGatherMatmulWithRdmaWrite<
        BlockMmad,
        BlockAllGather,
        BlockRdmaWrite,
        BlockMmadScheduler,
...
>
CATLASS_DEVICE
void AllGatherMatmulRdmaImpl_M0_256(
    Catlass::GemmCoord& problemShape,
    Catlass::GemmCoord& l1TileShape,
    GM_ADDR gmA, LayoutA& layoutA,
    GM_ADDR gmB, LayoutB& layoutB,
...
{
    AllGatherMatmulRdmaImpl<ArchTag, ElementA, LayoutA, ElementB, LayoutB, ElementC, LayoutC, 256, 128, 256>(
...
>
CATLASS_DEVICE
void AllGatherMatmulRdmaImpl_M0_128(
    Catlass::GemmCoord& problemShape,
    Catlass::GemmCoord& l1TileShape,
    GM_ADDR gmA, LayoutA& layoutA,
    GM_ADDR gmB, LayoutB& layoutB,
...
{
    AllGatherMatmulRdmaImpl<ArchTag, ElementA, LayoutA, ElementB, LayoutB, ElementC, LayoutC, 128, 256, 256>(
        problemShape, l1TileShape, gmA, layoutA, gmB, layoutB, gmC, layoutC,
        commInterval, commCoreSplit, commBlockShape, commTileShape, symmetricPtr
    );
}
...
>
CATLASS_GLOBAL
void AllGatherMatmulRdma(
    uint64_t fftsAddr, GM_ADDR gmA, GM_ADDR gmB, GM_ADDR gmC, GM_ADDR symmetricPtr, CocTilingParams cocTiling, GM_ADDR dump
)
{
...
)
{
    ...
    if(m0 == 128){
        AllGatherMatmulRdmaImpl_M0_128<ArchTag, ElementA, LayoutA, ElementB, LayoutB, ElementC, LayoutC>(
            problemShape, l1TileShape, gmA, layoutA, gmB, layoutB, gmC, layoutC,
            commInterval, commCoreSplit, commBlockShape, commTileShape, symmetricPtr
        );
    } else {
        AllGatherMatmulRdmaImpl_M0_256<ArchTag, ElementA, LayoutA, ElementB, LayoutB, ElementC, LayoutC>(
            problemShape, l1TileShape, gmA, layoutA, gmB, layoutB, gmC, layoutC,
            commInterval, commCoreSplit, commBlockShape, commTileShape, symmetricPtr
        );
    }
