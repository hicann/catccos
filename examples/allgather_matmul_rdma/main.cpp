 ...
 */
#include "allgather_matmul_rdma_host.h"
#include "allgather_matmul_rdma_device.h"
...
using Config = AllGatherMatmulRdmaConfig_M0_128<ElementA, LayoutA, ElementB, LayoutB, ElementC, LayoutC>;
...
int main(int argc, char **argv)
{
    ...
    if (!op) {
        std::cout << "Operator AllGatherMatmulRdma not found!" << std::endl;
        return -1;
    }
