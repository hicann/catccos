...
#include "allgather_matmul_shallow_fusion_device.h"
...
int main(int argc, char** argv)
{
    ...
    auto op = OperatorRegistry::Instance().CreateOperator("AllGatherMatmulShallowFusion");
    ...
    try {
        ...
        Catccos::Examples::AllGatherMatmulShallowFusionExample::Launch(
