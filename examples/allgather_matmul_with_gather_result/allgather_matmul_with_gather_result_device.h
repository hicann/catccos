...
using AllGatherMatmulWithGatherResultConfig_M0_128 =
    AllGatherMatmulWithGatherResultConfig<ElementA, LayoutA, ElementB, LayoutB, ElementC, LayoutC, 128, 256, 256>;

template <class ElementA, class LayoutA, class ElementB, class LayoutB, class ElementC, class LayoutC>
using AllGatherMatmulWithGatherResultConfig_M0_256 =
    AllGatherMatmulWithGatherResultConfig<ElementA, LayoutA, ElementB, LayoutB, ElementC, LayoutC, 256, 128, 256>;
