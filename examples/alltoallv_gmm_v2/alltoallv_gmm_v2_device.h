...
using AllToAllVGMMV2Config_M0_128 =
    AllToAllVGMMV2Config<ElementA, LayoutA, ElementB, LayoutB, ElementC, LayoutC, 128, 256, 256>;

template <class ElementA, class LayoutA, class ElementB, class LayoutB, class ElementC, class LayoutC>
using AllToAllVGMMV2Config_M0_256 =
    AllToAllVGMMV2Config<ElementA, LayoutA, ElementB, LayoutB, ElementC, LayoutC, 256, 128, 256>;
