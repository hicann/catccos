...
void MoeInitRoutingQuantV2TilingBase::ShowTilingData()
{
    ...
    printf("moeInitRoutingTilingData is coreNum:%ld, n:%ld, cols:%ld, k:%ld, expertCapacity:%ld, expertNum:%ld, "
           "dropPadMode:%ld, expertTokensCountOrCumsumFlag:%ld, expertTokensBeforeCapacityFlag:%ld\n",
           quantTilingData.coreNum,
           quantTilingData.n, quantTilingData.cols, quantTilingData.k, quantTilingData.expertCapacity,
           quantTilingData.expertNum,
           quantTilingData.dropPadMode, quantTilingData.expertTokensCountOrCumsumFlag,
           quantTilingData.expertTokensBeforeCapacityFlag);

    printf("InnerMoeV2VBSComputeTilingData is needCoreNum:%ld, perCoreElements:%ld, perCoreLoops:%ld, "
           ...
           quantTilingData.vbsComputeParamsOp.needCoreNum,
           quantTilingData.vbsComputeParamsOp.perCoreElements,
           quantTilingData.vbsComputeParamsOp.perCoreLoops,
           quantTilingData.vbsComputeParamsOp.perCorePerLoopElements,
           quantTilingData.vbsComputeParamsOp.perCoreLastLoopElements,
           quantTilingData.vbsComputeParamsOp.lastCoreElements,
           quantTilingData.vbsComputeParamsOp.lastCoreLoops,
           quantTilingData.vbsComputeParamsOp.lastCorePerLoopElements,
    ...
    printf("SortOutComputeTilingData is oneLoopMaxElements:%ld\n",
           quantTilingData.sortOutComputeParamsOp.oneLoopMaxElements);

    printf("SrcToDstComputeTilingData is needCoreNum:%ld, activateRows:%ld, perCoreRows:%ld, perCorePerLoopRows:%ld, "
           "perCoreLastLoopRows:%ld, lastCoreRows:%ld, lastCorePerLoopRows:%ld, lastCoreLastLoopRows:%ld\n",
           quantTilingData.srcToDstComputeParamsOp.needCoreNum,
           quantTilingData.srcToDstComputeParamsOp.activateRows,
           quantTilingData.srcToDstComputeParamsOp.perCoreRows,
           quantTilingData.srcToDstComputeParamsOp.perCorePerLoopRows,
    ...
    printf("SrcToDstComputeCapacityTilingData is needCoreNum:%ld, perCoreRows:%ld, perCorePerLoopRows:%ld, "
           "perCoreLastLoopRows:%ld, lastCoreRows:%ld, lastCorePerLoopRows:%ld, lastCoreLastLoopRows:%ld\n",
    ...
    printf("GatherOutComputeTilingData is needCoreNum:%ld, activateRows:%ld, perCoreRows:%ld, perCorePerLoopRows:%ld, "
           ...
           quantTilingData.gatherOutComputeParamsOp.needCoreNum,
           quantTilingData.gatherOutComputeParamsOp.activateRows,
           ...
           quantTilingData.gatherOutComputeParamsOp.perCoreLoops,
           quantTilingData.gatherOutComputeParamsOp.lastCoreLoops,
