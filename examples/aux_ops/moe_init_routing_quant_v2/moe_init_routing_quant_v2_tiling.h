...
inline static int64_t AlignOneBlockByteCeil(int64_t x) { return x / ONE_BLOCK_BYTE * ONE_BLOCK_BYTE; }
...
void MoeInitRoutingQuantV2TilingBase::ShowTilingData()
{
    printf("smoothType %ld\n", quantTilingData.smoothType);
    ...
    printf(
        ...
        quantTilingData.coreNum, quantTilingData.n, quantTilingData.cols, quantTilingData.k,
        quantTilingData.expertCapacity, quantTilingData.expertNum, quantTilingData.dropPadMode,
        quantTilingData.expertTokensCountOrCumsumFlag, quantTilingData.expertTokensBeforeCapacityFlag);
    ...
    printf(
        ...
        quantTilingData.vbsComputeParamsOp.needCoreNum, quantTilingData.vbsComputeParamsOp.perCoreElements,
        quantTilingData.vbsComputeParamsOp.perCoreLoops, quantTilingData.vbsComputeParamsOp.perCorePerLoopElements,
        quantTilingData.vbsComputeParamsOp.perCoreLastLoopElements, quantTilingData.vbsComputeParamsOp.lastCoreElements,
        quantTilingData.vbsComputeParamsOp.lastCoreLoops, quantTilingData.vbsComputeParamsOp.lastCorePerLoopElements,
        quantTilingData.vbsComputeParamsOp.lastCoreLastLoopElements,
        quantTilingData.vbsComputeParamsOp.oneLoopMaxElements);

    printf("VMSMiddleComputeTilingData is needCoreNum:%ld\n", quantTilingData.vmsMiddleComputeParamsOp.needCoreNum);
    printf(
        "SortOutComputeTilingData is oneLoopMaxElements:%ld\n",
    ...
    printf(
        ...
        quantTilingData.srcToDstComputeParamsOp.needCoreNum, quantTilingData.srcToDstComputeParamsOp.activateRows,
        quantTilingData.srcToDstComputeParamsOp.perCoreRows, quantTilingData.srcToDstComputeParamsOp.perCorePerLoopRows,
        quantTilingData.srcToDstComputeParamsOp.perCoreLastLoopRows,
        quantTilingData.srcToDstComputeParamsOp.lastCoreRows,
        quantTilingData.srcToDstComputeParamsOp.lastCorePerLoopRows,
        quantTilingData.srcToDstComputeParamsOp.lastCoreLastLoopRows);
    printf(
        "SrcToDstComputeCapacityTilingData is needCoreNum:%ld, perCoreRows:%ld, perCorePerLoopRows:%ld, "
        "perCoreLastLoopRows:%ld, lastCoreRows:%ld, lastCorePerLoopRows:%ld, lastCoreLastLoopRows:%ld\n",
        quantTilingData.srcToDstCapacityComputeParamsOp.needCoreNum,
        quantTilingData.srcToDstCapacityComputeParamsOp.perCoreRows,
        quantTilingData.srcToDstCapacityComputeParamsOp.perCorePerLoopRows,
        quantTilingData.srcToDstCapacityComputeParamsOp.perCoreLastLoopRows,
        quantTilingData.srcToDstCapacityComputeParamsOp.lastCoreRows,
        quantTilingData.srcToDstCapacityComputeParamsOp.lastCorePerLoopRows,
        quantTilingData.srcToDstCapacityComputeParamsOp.lastCoreLastLoopRows);
    printf(
        "GatherOutComputeTilingData is needCoreNum:%ld, activateRows:%ld, perCoreRows:%ld, perCorePerLoopRows:%ld, "
        "perCoreLastLoopRows:%ld, lastCoreRows:%ld, lastCorePerLoopRows:%ld, "
        "lastCoreLastLoopRows:%ld, perCoreLoops:%ld, lastCoreLoops:%ld colLoop:%ld\n",
        quantTilingData.gatherOutComputeParamsOp.needCoreNum, quantTilingData.gatherOutComputeParamsOp.activateRows,
        quantTilingData.gatherOutComputeParamsOp.perCoreRows,
        quantTilingData.gatherOutComputeParamsOp.perCorePerLoopRows,
        quantTilingData.gatherOutComputeParamsOp.perCoreLastLoopRows,
        quantTilingData.gatherOutComputeParamsOp.lastCoreRows,
        quantTilingData.gatherOutComputeParamsOp.lastCorePerLoopRows,
        quantTilingData.gatherOutComputeParamsOp.lastCoreLastLoopRows,
        quantTilingData.gatherOutComputeParamsOp.perCoreLoops, quantTilingData.gatherOutComputeParamsOp.lastCoreLoops,
        quantTilingData.gatherOutComputeParamsOp.colLoops);
}
...
bool MoeInitRoutingQuantV2TilingBase::GetShapeAttrsInfo(
    int64_t m, int64_t cols, int64_t topK, int64_t expertCapacity, int64_t expertNum, int64_t activeNum,
    int64_t dropPadMode, int64_t expertTokensCountOrCumsumFlag, bool expertTokensBeforeCapacityFlag,
    int64_t inuptXDtypeSize, int64_t quantMode, int64_t scaleDim0)
{
    InnerMoeInitRoutingV2TilingBase::GetShapeAttrsInfo(
...
void SetGatherTilingDatawithloop(
    InnerMoeV2GatherOutComputeTilingData* tilingData, int64_t perCorePerLoopRows, int64_t lastCorePerLoopRows,
    int64_t cols, int64_t perCoreLastLoopRows = 1, int64_t lastCoreLastLoopRows = 1, int64_t perCoreLoops = 1,
...
void MoeInitRoutingQuantV2TilingBase::Tiling4GatherDynamicQuant()
{
    ...
    if (rowSize + colSize + scaleSize < static_cast<int64_t>(aicoreParams_.ubSize) || ifOneLoop) {
        SetGatherTilingDatawithloop(
            tilingData, perCoreOnceRowSize, lastCoreOnceRowSize, cols, perCoreLastLoopRows, lastCoreLastLoopRows,
...
#endif // ASCENDC_DISPATCH_FFN_COMBINE_INIT_ROUTING_QUANT_TILING_H
