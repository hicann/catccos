 ...
 */
#ifndef ASCEND950_ALLGATHER_MATMUL_UDMA_HOST_H
#define ASCEND950_ALLGATHER_MATMUL_UDMA_HOST_H

#include "operator_registry.h"

class Ascend950AllGatherMatmulUdmaOperator : public CatccosOperator {
public:
    ...
    CocCommType GetActualKernelType(const CocTilingParams &cocTiling) override {
        return CocCommType::ASCEND950_ALLGATHER_MATMUL_UDMA;
    }
...
REGISTER_OPERATOR("Ascend950AllGatherMatmulUdma", Ascend950AllGatherMatmulUdmaOperator);

#endif  // ASCEND950_ALLGATHER_MATMUL_UDMA_HOST_H
