...
using Ascend950Fp4MxGroupedMatmulAllToAllVConfig_M0_128 = 
    Ascend950Fp4MxGroupedMatmulAllToAllVConfig<ElementA, LayoutA, ElementB, LayoutB, ElementD, LayoutD, ElementMxScale, 128, 256, 512>;

template <class ElementA, class LayoutA, class ElementB, class LayoutB, class ElementD, class LayoutD, class ElementMxScale>
using Ascend950Fp4MxGroupedMatmulAllToAllVConfig_M0_256 = 
    Ascend950Fp4MxGroupedMatmulAllToAllVConfig<ElementA, LayoutA, ElementB, LayoutB, ElementD, LayoutD, ElementMxScale, 256, 128, 512>;
