                                         ...
                                         GM_ADDR symmetricPtr, uint32_t rank, uint32_t rankSize)
{
    ...
    // MX quant block
    using BlockMxQuant =
        Catccos::Comm::Block::CommBlockMxQuant<UB_STAGES, BLOCK_SIZE, ROUND_MODE, InputType, OutputType>;
                                     ...
                                     GM_ADDR commArgsPtr, CocTilingParams cocTiling, uint32_t magic)
{
    ...
    MxQuantAllGatherImpl<ArchTag, ElementInput, LayoutInput, ElementOutput, LayoutOutput>(
        problemShape, gmInput, layoutInput, gmOutput, layoutOutput, gmMxScale, commInterval, commCoreSplit,
