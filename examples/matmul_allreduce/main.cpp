...
#include "matmul_allreduce_host.h"
...
struct Options {
    static constexpr auto HELPER = "Usage: matmul_allreduce rank_size rank_id ip_port m n k [device_id_list]\n";
...
int main(int argc, char** argv)
{
    ...
    auto op = OperatorRegistry::Instance().CreateOperator("MatmulAllReduce");
    if (!op) {
        std::cout << "Operator MatmulAllReduce not found!" << std::endl;
        return -1;
    }
