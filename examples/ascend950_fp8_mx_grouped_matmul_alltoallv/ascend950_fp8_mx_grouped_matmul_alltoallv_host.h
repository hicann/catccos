   ...
   public:
                             ...
                             std::string dataFile) override
    {
        ...
        else
        {
            ...
            ACL_CHECK(aclrtMemcpy(aMxScaleDevice, sizeMxScaleA, matrixAMxScale.data(), sizeMxScaleA,
        ...
        else
        {
            ...
            ACL_CHECK(aclrtMemcpy(bMxScaleDevice, sizeMxScaleB, matrixBMxScale.data(), sizeMxScaleB,
                                  ACL_MEMCPY_HOST_TO_DEVICE));
        }
        ...
        ACL_CHECK(aclrtMalloc((void **)(&globalTokensPerLocalExpertDevice), globalTokensPerLocalExpertSize,
        ...
        if (dataFile != "")
        {
            ...
            ACL_CHECK(aclrtMemcpy(localTokensPerExpertDevice, localTokensPerExpertSize, localTokensPerExpertHost,
            ...
            ACL_CHECK(aclrtMemcpy(globalTokensPerLocalExpertDevice, globalTokensPerLocalExpertSize,
                                  globalTokensPerLocalExpertHost, globalTokensPerLocalExpertSize,
                                  ACL_MEMCPY_HOST_TO_DEVICE));
        }
        else
        {
            ...
            std::vector<uint32_t> matrixG(gSize / sizeof(uint32_t),
                                          cocTiling.m / cocTiling.expertNum * cocTiling.rankSize / cocTiling.epSize);
            ACL_CHECK(
        ...
        params.SetKernelParams(aDevice, bDevice, cDevice, aMxScaleDevice, bMxScaleDevice, localTokensPerExpertDevice,
