 ...
 */
#ifndef ASCEND950_FP8_MX_ALLGATHER_MATMUL_HOST_H
#define ASCEND950_FP8_MX_ALLGATHER_MATMUL_HOST_H

#include "catlass/detail/alignment.hpp"
#include "operator_registry.h"

class Ascend950Fp8MxAllGatherMatmulOperator : public CatccosOperator {
public:
    ...
    {
        return CocCommType::ASCEND950_FP8_MX_ALLGATHER_MATMUL;
    }
...
// 注册这个算子
REGISTER_OPERATOR("Ascend950Fp8MxAllGatherMatmul", Ascend950Fp8MxAllGatherMatmulOperator);

#endif // ASCEND950_FP8_MX_ALLGATHER_MATMUL_HOST_H
