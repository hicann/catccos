...
public:
    ...
    void operator()<AscendC::AIC>(Params const &params)
    {
        ...
        auto layoutTagSymmetric = Catlass::layout::RowMajor::MakeLayout<ElementC>(
            commShapeM * params.rankSize, chunkN);
        ...
        for (uint32_t commIdx = 0; commIdx < commLoops; ++commIdx) {
            ...
            auto actualProblemShape = Catlass::MakeCoord<uint32_t>(
                actualCommM, problemShapeInRank.n(), problemShapeInRank.k());
            ...
            for (uint32_t blockIdx = aicoreIdx; blockIdx < coreLoops; blockIdx += aicoreNum) {
                ...
                auto tensorBlockMxScaleA = GetTile(tensorMxScaleA,
                    ...
                    tla::MakeShape(actualBlockShape.m(),
                                   CeilDiv<Catlass::MX_SCALE_GROUP_NUM>(actualBlockShape.k())));
                ...
                auto tensorBlockMxScaleB = GetTile(tensorMxScaleB,
                    ...
                    tla::MakeShape(CeilDiv<Catlass::MX_SCALE_GROUP_NUM>(actualBlockShape.k()),
                                   actualBlockShape.n()));
                ...
                if (targetRankIdx == params.rankIdx) {
                    ...
                    auto tensorBlockD = GetTile(tensorD, blockOffsetD,
                    ...
                    auto blockOffsetSymm = tla::MakeCoord(offsetMN.row() + targetRankIdx * commShapeM, offsetMN.column() - targetRankIdx * chunkN);
