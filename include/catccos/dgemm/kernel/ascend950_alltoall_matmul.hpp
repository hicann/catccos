...
template <
    class BlockMmad_, class BlockAllToAll_, class BlockScheduler_, class BlockAllToAllScheduler_,
...
public:
    ...
    static Params ToUnderlyingArguments(Arguments const& args, uint8_t* workspace = nullptr)
    {
        ...
        return Params(
            args.problemShape, args.rankIdx, args.rankSize, args.commInterval, layoutAllToAllSrc, args.ptrA, layoutA,
            args.ptrB, layoutB, args.ptrC, layoutC, args.ptrSymmetric, allToAllParams, commParams);
    }
