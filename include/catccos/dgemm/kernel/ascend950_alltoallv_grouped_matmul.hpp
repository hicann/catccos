...
public:
    ...
    static Params ToUnderlyingArguments(Arguments const& args, uint8_t* workspace = nullptr)
    {
        ...
        return Params(
            problemShape, args.commInterval, args.ptrA, layoutA, args.ptrB, layoutB, args.ptrC, layoutC, tagA, tagB,
            gmSymmetric, syncMmadFinish, syncCommFinish, blockCommParams);
    }
    ...
    CATLASS_DEVICE void operator()<AscendC::AIC>(Params const& params)
    {
        ...
        auto layoutTagSymmetric =
            Catlass::layout::RowMajor(WORKSPACE_STAGES * rankSize * commShapeM, params.problemShape.k());
