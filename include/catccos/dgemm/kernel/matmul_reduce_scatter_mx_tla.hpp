...
#ifndef CATCCOS_DGEMM_KERNEL_MATMUL_REDUCE_SCATTER_MX_TLA_HPP
#define CATCCOS_DGEMM_KERNEL_MATMUL_REDUCE_SCATTER_MX_TLA_HPP
...
public:
    ...
    static Params ToUnderlyingArguments(Arguments const &args, uint8_t *workspace = nullptr)
    {
        ...
        LayoutTagC layoutTagC{args.problemShape.m() / args.rankSize, args.problemShape.n()};
