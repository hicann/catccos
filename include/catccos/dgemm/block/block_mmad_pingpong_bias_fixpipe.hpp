...
#ifndef CATCCOS_DGEMM_BLOCK_BLOCK_MMAD_PINGPONG_BIAS_FIXPIPE_HPP
#define CATCCOS_DGEMM_BLOCK_BLOCK_MMAD_PINGPONG_BIAS_FIXPIPE_HPP
...
public:
    ...
    using TileMmad = Catlass::Gemm::Tile::TileMmad<ArchTag, AType_, BType_, BiasType_>;
    ...
    using CopyL0CToGm = Catlass::Gemm::Tile::CopyL0CToGm<ArchTag, ElementAccumulator, CType_,
    ...
    BiasFixpipeBlockMmad(Catlass::Arch::Resource<ArchTag> &resource, uint32_t l1BufAddrStart = 0)
    {
        ...
        uint32_t l1SOffset = l1BiasOffset + L1BIAS_SIZE * STAGES;
        // Init buffers
        ...
        GemmCoord const &actualShape)
    {
        ...
        if constexpr (!ENABLE_UNIT_FLAG) {
            ...
            copyL0CToGm(gmC, l0CTensor, l1STensor, layoutBlock, layoutInL0C);
            AscendC::SetFlag<AscendC::HardEvent::FIX_M>(EVENT_ID0);
        } else {
            copyL0CToGm(gmC, l0CTensor, l1STensor, layoutBlock, layoutInL0C, 0b11);
        }
        AscendC::SetFlag<AscendC::HardEvent::FIX_MTE2>(0);
    }
...
#endif // CATCCOS_DGEMM_BLOCK_BLOCK_MMAD_PINGPONG_BIAS_FIXPIPE_HPP
