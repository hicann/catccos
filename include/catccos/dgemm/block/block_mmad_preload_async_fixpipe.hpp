...
#ifndef CATCCOS_GEMM_BLOCK_BLOCK_MMAD_PRELOAD_ASYNC_FIXPIPE_HPP
#define CATCCOS_GEMM_BLOCK_BLOCK_MMAD_PRELOAD_ASYNC_FIXPIPE_HPP
...
public:
    ...
    using BiasType = void;
    using TileCopy_ = Gemm::Tile::TileCopy<ArchTag, AType_, BType_, CType_, BiasType>;
    using TileMmad_ = Gemm::Tile::TileMmad<ArchTag, AType_, BType_, BiasType>;
    ...
    static constexpr uint32_t L1S_TILE_SIZE = L1TileShape::N * sizeof(ElementScale);
    // L0 tile size
...
private:
    struct L1TileMmadParams {
        ...
        LayoutC layoutCInGm;
        Catlass::layout::VectorLayout layoutScale;
        Callback callback;
