...
struct BlockMmad<
    Catccos::Gemm::MmadAtlasA2PingpongOptionalBias<ENABLE_UNIT_FLAG_>, L1TileShape_, L0TileShape_, AType_, BType_,
    CType_, BiasType_, TileCopy_, TileMmad_> {
public:
    // Type Aliases
    using DispatchPolicy = Catccos::Gemm::MmadAtlasA2PingpongOptionalBias<ENABLE_UNIT_FLAG_>;
    ...
    void operator()(
        ...
        AscendC::GlobalTensor<ElementBias> const& gmBias, Catlass::GemmCoord const& actualShape)
    {
            ...
            for (int mPartIdx = 0; mPartIdx < mPartLoop; mPartIdx++) {
                ...
                for (int kPartIdx = 0; kPartIdx < kPartLoop; kPartIdx++) {
                    ...
                    for (int nPartIdx = 0; nPartIdx < nPartLoop; nPartIdx++) {
                        ...
                        if (initC && gmBias.GetPhyAddr() != nullptr) {
                            if (nPartIdx == 0) {
