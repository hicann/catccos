...
#ifndef CATCCOS_COMM_BLOCK_SCHEDULER_ALLTOALLV_GMM_HPP
#define CATCCOS_COMM_BLOCK_SCHEDULER_ALLTOALLV_GMM_HPP
...
struct BlockCommSchedulerGmmAllToAllV {
    ...
    CATLASS_DEVICE
    BlockCommSchedulerGmmAllToAllV() = default;
        ...
        tokenPerExpert(tokenPerExpert_)
    {
        ...
        Catlass::Arch::CrossCoreFlag flagAivFinishCumsum = Catlass::Arch::CrossCoreFlag(0);
        Catlass::Arch::CrossCoreBarrier<0x0, PIPE_MTE3>();
        Catlass::Arch::CrossCoreSetFlag<0x2, PIPE_MTE3>(flagAivFinishCumsum);
    }
